...
class SortRunner {
    ...
    // ALL: 
    //static final Sorter[] ALGS1 = { new Insertion(), new Merge(), new Quick(), new Heap(), new Bubble(), new Selection(), new Bucket(), new Radix() };
    
    static final Sorter[] ALGS1 = { new Insertion(), new Merge(), new Bubble(), new Selection(), new Quick(), new Heap(), new Bucket(), new Radix()}; // RADIX IS THE PROBLEM. Out of bounds. 
    
    // Put the sorting algorithms under test for part 2 here// Put the sorting algorithms under test for part 2 here
    
    // ALL 
    //static final Sorter[] ALGS2 = { new Insertion(), new Merge(), new Quick(), new Heap(), new Bubble(), new Selection(), new Bucket(), new Radix() };

    static final Sorter[] ALGS2 = { new Insertion(), new Merge(), new Bubble(), new Selection(), new Quick(), new Heap(), new Bucket(), new Radix()};

    //static final Sorter[] ALGS1 = { new Insertion(), new Merge() };  <- Original 
    //static final Sorter[] ALGS2 = { new Insertion(), new Merge() };  <- Original 
